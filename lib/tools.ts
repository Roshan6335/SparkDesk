...
// Each category gets a distinct accent so the workspace reads like Genspark's
// color-coded rows at a glance, rather than one uniform brand-purple grid.
const CATEGORY_COLORS: Record<string, { bg: string; fg: string }> = {
  "Writing & Content": { bg: "#FFF1E6", fg: "#E8703A" },
  "Design & Visuals": { bg: "#F5EBFF", fg: "#9B4FE0" },
  "Audio & Video": { bg: "#E6F9F1", fg: "#1FA971" },
  "Business & Productivity": { bg: "#E8F0FF", fg: "#3366E6" },
};
...
export function getCategoryColor(category: string) {
  return CATEGORY_COLORS[category] || { bg: "#F2F5FF", fg: "#5B57F5" };
}
