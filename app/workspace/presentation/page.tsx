...
import { Presentation, Loader2, Sparkles, ChevronDown, ChevronUp } from "lucide-react";
...
export default function PresentationPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-8 py-10">
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-ink-500">
            Generate a slide-by-slide outline with speaker notes. (PPTX export coming soon.)
          </p>
        </div>
      </div>
      ...
      {deck && (
        <div className="mt-6">
          <h2 className="mb-4 font-display text-lg font-bold text-ink-900">{deck.title}</h2>
