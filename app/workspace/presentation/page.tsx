  ...
  return (
    <div className="mx-auto max-w-3xl px-8 py-10">
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          <h1 className="font-display text-xl font-bold text-ink-900">AI Presentation Outliner</h1>
      ...
      {deck && (
        <div className="mt-6">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="font-display text-lg font-bold text-ink-900">{deck.title}</h2>
            <button
          ...
          {exportError && (
            <div className="mb-4 rounded-xl2 border border-red-200 bg-red-50 px-5 py-3 text-sm text-red-600">
              {exportError}
            </div>
          )}
          <div className="space-y-3">
            {deck.slides.map((slide, i) => (
              <div key={i} className="rounded-xl2 border border-surface-border bg-white shadow-card">
                <button
                ...
                {expanded === i && (
                  <div className="border-t border-surface-border px-5 py-4">
                    ...
                    <p className="rounded-lg bg-surface-soft px-3 py-2 text-xs italic text-ink-500">
